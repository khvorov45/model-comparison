...
\input{hanam-application}

%------------------------------------------------------------------------------
\subsection{Scaled logit fit}

\input{hanam-scaled-logit-fit}

%------------------------------------------------------------------------------
\subsection{Comparison to standard logistic fit}

\input{hanam-logistic-fit}

%==============================================================================
\section{Kiddyvax application}

\input{kiddyvax-application}

%------------------------------------------------------------------------------
\subsection{Scaled logit fit}

\input{kiddyvax-scaled-logit-fit}

%------------------------------------------------------------------------------
\subsection{Standard logistic fit}

\input{kiddyvax-logistic-fit}

%------------------------------------------------------------------------------
\subsection{Cox proportional hazards fit}

\input{kiddyvax-cox-fit}
