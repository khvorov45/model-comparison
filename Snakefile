...
rule preds_plot:
    ...
    output:
        ...
        "preds-plot/sophia-cox-fixci-fixmod.pdf",
        "preds-plot/hanam-hi-lr.pdf",
        "preds-plot/hanam-hi-lr-boot.pdf",
        "preds-plot/hanam-hi-lr-boot-rel.pdf",
        "preds-plot/hanam-hi-lr-boot-inf.pdf",
        "preds-plot/hanam-hi-sclr.pdf",
        "preds-plot/hanam-hi-lr-h3.pdf",
        "preds-plot/hanam-hi-lr-inf.pdf",
        "preds-plot/kiddyvaxmain-lr.pdf",
        "preds-plot/kiddyvaxmain-lr-boot.pdf",
        "preds-plot/kiddyvaxmain-lr-boot-rel.pdf",
        "preds-plot/kiddyvaxmain-lr-boot-inf.pdf",
